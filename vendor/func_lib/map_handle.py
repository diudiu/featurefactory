...
def m_get_mon_sub(result, args):
    ...
    result = round(result, args)
    return result


def m_get_date_to_now_years(result, args):
    """比较传进来的['2016-01-01'] or '2016-01-01' 距离现在的年数 args保留小数点位数"""
