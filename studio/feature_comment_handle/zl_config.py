...
config = dict(
    ...
    income_level_config={
        ...
        "default_value": "PositiveSignedTypeDefault",
        "json_path_list": [
            ("portrait_data", "$.portrait_data.work_exp_form",
             "m_lp_income(0.56)->m_check_code('income_level', 'gte_lt')"),
            ("cc_credit", "$..debit_card_12m_passentry_amount",
             "m_single_check_code('income_level_yd')->m_single_to_list"),
            ("unicom_finance_portrait_s", "$..last12.debit.income_range",
             "m_single_check_code('income_level_lt')->m_single_to_list"),
        ],
        "f_map_and_filter_chain": "m_to_sum",
        "reduce_chain": "",
        "l_map_and_filter_chain": "",
