...
is_recruitment_config = {
    ...
    "feature_data_type": "int",
    "default_value": "BooleanTypeDefault",
    "json_path_list": [("education_approach", "$..education_approach", "f_assert_not_null->f_assert_must_basestring")],
...
college_type_config = {
    ...
    "feature_data_type": "str",
    "default_value": "StringTypeDefault",
    "json_path_list": [("school_nature", "$.content.college.school_nature", "f_assert_not_null->f_assert_must_basestring"),
