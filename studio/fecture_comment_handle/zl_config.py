...
education_degree_code_config = {
    ...
    "feature_data_type": "int",
    "default_value": "PositiveSignedTypeDefault",
    "json_path_list": [("education_degree_code", "$..degree", "f_not_null->f_assert_must_digit")],
    "f_map_and_filter_chain": "m_to_int->r_min->m_to_str->m_single_to_list->m_single_check_code('education_degree_code')",
    "reduce_chain": "",
    "l_map_and_filter_chain": "",
}
...
income_level_config = {
    ...
    "default_value": "PositiveSignedTypeDefault",
    "json_path_list": [
        ("portrait_data", "$.portrait_data.work_exp_form", "m_lp_income(0.56)->m_check_code('income_level', 'gte_lt')"),
        ("cc_credit", "$..debit_card_12m_passentry_amount", "m_single_check_code('income_level_yd')->m_single_to_list"),
        ("unicom_finance_portrait_s", "$..last12.debit.income_range", "m_single_check_code('income_level_lt')->m_single_to_list"),
    ],
    "f_map_and_filter_chain": "m_to_sum",
    "reduce_chain": "",
    "l_map_and_filter_chain": "",
...
overspeed_count_config = {
    ...
    "feature_data_type": "int",
    "default_value": "PositiveSignedTypeDefault",
    "json_path_list": [("overspeed_count", "$..month_times", "f_not_null->f_assert_not_null->f_assert_must_digit")],
    "f_map_and_filter_chain": "m_to_int->m_to_sum",
    "reduce_chain": "",
    "l_map_and_filter_chain": "",
}
...
overload_count_config = {
    ...
    "feature_data_type": "int",
    "default_value": "PositiveSignedTypeDefault",
    "json_path_list": [("overload_count", "$..month_times", "f_not_null->f_assert_not_null->f_assert_must_digit")],
    "f_map_and_filter_chain": "m_to_int->m_to_sum",
    "reduce_chain": "",
    "l_map_and_filter_chain": "",
}
